...
Questions[0] = "1) The father of C,C++ & Unix is";
...
Questions[1] = "2) The Open source among following is  ";
...
Questions[2] = "3) Pancake Sorting Algorithm and BASIC Interpreter was written by";
...
Questions[3] = "4) Larry page and Sergei Brinn are Co-Founders of ";
Answers[3][0] = "Yahoo";
Answers[3][1] = "Rediff";
Answers[3][2] = "Google";
Answers[3][3] = "Apple";
...
Questions[4] = "5) The first computer to defeat Chess Grandmaster was";
...
function NextQuestion() {
    ...
    QuestionNo++;
    if (QuestionNo == 5) {
        alert("Exam Over and Your Score is  " + Marks);
        QuestionNo = 4;
    }
    load();
}